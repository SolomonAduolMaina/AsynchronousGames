...
valid_walk (event_structure_sum P Q E F)
        (non_empty_walk (event_structure_sum P Q E F) p0
           (inr y0, b0) w)) ->
source_walk _ (cast_to_left_in_walk_sum P Q E F w) = nil.
Proof. intros. induction w.
...
valid_walk (event_structure_sum P Q E F)
        (non_empty_walk (event_structure_sum P Q E F) p0
           (inl y0, b0) w)) ->
source_walk _ (cast_to_right_in_walk_sum P Q E F w) = nil.
Proof. intros. induction w.
+ simpl. destruct H. destruct H. destruct H. destruct H.
++ inversion H.
++ inversion H. subst p1. subst m. subst ep. subst p2.
...
(m':=(x0,b0)) (w'0:=(cast_to_left_in_walk_sum P Q E F w')).
+++++++ reflexivity.
+++++++ split.
...
assert (source_walk _ (cast_to_left_in_walk_sum P Q E F w') = nil).
...
destruct (cast_to_left_in_walk_sum P Q E F w') eqn:IND.
...
assert (source_walk _ (cast_to_right_in_walk_sum P Q E F w') = nil).
...
destruct (cast_to_right_in_walk_sum P Q E F w') eqn:IND.
++++++++++ simpl in H9. subst p1.
apply valid_one_move_walk with 
...
(m':=(y0,b0)) (w'0:=(cast_to_right_in_walk_sum P Q E F w')).
+++++++ reflexivity.
+++++++ split.
